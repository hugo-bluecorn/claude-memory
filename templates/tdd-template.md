...
**Test Code Location:** `test/[test_file]_test.dart` or equivalent
...
### File Structure
- **Source:** `lib/[source_file].dart` or equivalent for your framework
- **Tests:** `test/[test_file]_test.dart` or equivalent

### Framework-Specific Information

**Test Framework:** [e.g., `test`, `pytest`, `jest`, `vitest`]
**Test Command:** [e.g., `dart test`, `pytest`, `npm test`]
**Analysis Command:** [e.g., `dart analyze`, `pylint`, `eslint`]
